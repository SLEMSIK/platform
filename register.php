    ...
    <div class="min-vh-100 d-flex flex-column justify-content-between">
        <div>
            ...
            <div class="loginContainer shadow-sm text-center px-5 py-3">
                ...
                <input class="form-control data" name="name" id="textMessage" type="text" placeholder="Введите ваше имя">
                <input class="form-control data" name="login" id="textMessage" type="email" placeholder="Введите почту">
                <input class="form-control data" name="password" id="textMessage" type="password" placeholder="Введите пароль">
                <div>
